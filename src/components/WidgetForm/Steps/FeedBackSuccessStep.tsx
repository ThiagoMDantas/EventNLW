...
interface NewFeedbackRestartProps{
  onFeedbackRestart: () => void;

}
export function FeedBackSuccessStep(props : NewFeedbackRestartProps) {
  return (
    <>
      ...
      <Checks className="w-12 h-12 text-brand-500" weight="bold"/>

        <span className="text-xl">
          Agradecemos seu Feefback!!
        </span>
